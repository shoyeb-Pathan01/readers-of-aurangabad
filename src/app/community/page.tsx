    ...
    <div className="py-20 md:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2">
          <FadeIn>
            <div>
              <h3 className="font-heading text-2xl tracking-wide text-[--accent-brass]">Our Mission</h3>
              ...
              <div className="mt-6 flex items-center gap-2 text-sm text-[--accent-brass]">
          ...
          <FadeIn delay={0.2}>
            <div className="rounded-lg border border-[--border-hairline] bg-[--surface-card] p-6 amber-shadow">
              <h4 className="font-heading text-lg tracking-wide text-[--accent-brass]">A Typical Sunday</h4>
              <ol className="mt-4 space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3 text-sm text-[--text-secondary]">
                    <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-[--accent-brass] text-xs text-[--accent-brass]">
                      {i + 1}
                    </span>
                    {item}
                  </li>
