    ...
    <div className="py-20 md:py-24">
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
        ...
        <div className="mt-12 md:mt-14">
          <h3 className="font-heading text-xl tracking-wide text-[--accent-gold] mb-6">Upcoming Meetups</h3>

          {upcomingMeetups.length > 0 ? (
            <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
              {upcomingMeetups.map((meetup) => (
                <ArchCard key={meetup.date} className="h-full group">
                  <ArchCardContent className="pt-8 pb-6">
                    <div className="flex items-center gap-2 text-sm text-[--accent-gold] mb-3">
        ...
        <div className="mt-14">
          ...
          <div className="space-y-3">
            {pastMeetups.map((meetup, i) => (
              ...
              >
                <span className="font-heading text-base text-[--accent-gold] w-24 shrink-0">{meetup.date}</span>
